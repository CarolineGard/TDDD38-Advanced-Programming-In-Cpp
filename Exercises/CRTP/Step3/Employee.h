...
namespace IDA_Person
{
   ...
   class Employee : public Person_Cloneable<Person, Employee>
   {
   public:
      Employee(const std::string& name,
               ...
               double             salary,
               int                dept = 0)
       : Person_Cloneable{name, crn}, e_date_{ e_date }, e_number_{ e_nbr }, salary_{ salary }, dept_{ dept }
      {}
      ...
      Employee(const Employee&) = default; //should be in protected
   protected:
      friend Person_Cloneable<Person, Employee>;
