...
public:
    ...
    Container(std::initializer_list<T>);    // Constructor to create a Container with an initialization list
    ...
    //placement version of push_back()
    template<typename ... Types>
    void emplace_back(Types&&... args); // added
